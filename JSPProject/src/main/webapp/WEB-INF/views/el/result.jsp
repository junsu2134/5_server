...
<body>
	...
	<!-- 
		...
		2. EL은 null을 빈칸으로 출력함(null과 관련된 것은 모두 빈칸)
	...
	<pre>
		...
		\${ 속성key.필드명 }
		(단, 객체 메소드에 getter가 작성되어 있어야지만 가능)
	</pre>
	...
	<pre>
		...
		+ NullPointerException이 발생하는 코드에서도 ""(빈문자열)을 출력한다.
	...
	<%
		...
		// list가 ArrayList 객체를 참조 == null이 아니다.
